// Basic fragment shader for showing a texture
uniform sampler2D uImage; // The texture passed as a uniform
varying vec2 vUv;
uniform float uTime;
...
void main() {
	...
	gl_FragColor = tex; // Sample the texture using UV coordinates
}